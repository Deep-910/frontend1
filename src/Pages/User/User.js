...
import { faAngleDown, faAngleRight, faBagShopping, faPowerOff, faUserAlt } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className='lg:w-4/5 mb-[2rem]'>
                {profile && (
                    <div className='w-full border-2 rounded-xl p-[1rem] lg:p-[2rem]'>
                        ...
                        <form className='flex flex-col gap-[1rem] py-[2rem]' action="submit">
                            <label className='flex items-center gap-[1rem]' htmlFor="name">Name
                                <input required className='border-2 outline-none p-1 rounded-lg w-full lg:w-[30rem]' type="text" placeholder='Name' />
                            </label>
                            <label className='flex items-center gap-[1rem]' htmlFor="email">Email
                                <input required className='border-2 outline-none p-1 rounded-lg w-full lg:w-[30rem]' type="email" placeholder='Email' />
                            </label>
                            <label className='flex items-center gap-[1rem]' htmlFor="phone">Phone
                                <input required className='border-2 outline-none p-1 rounded-lg w-full lg:w-[30rem]' type="text" placeholder='Phone' />
                            </label>
                            <button type="submit" className='bg-orange-500 text-white p-2 rounded-lg'>Save Changes</button>
                        </form>
                    </div>
                )}
                {address && (
                    <div className='w-full border-2 rounded-xl p-[1rem] lg:p-[2rem]'>
                        ...
                        <div className='flex flex-col gap-[2rem] py-[2rem]'>
                            <div className='border-2 rounded-lg p-4'>
                                <h2 className='text-xl font-semibold'>Address 1</h2>
                                <p>123, Main Street, City, State - 12345</p>
                                <button className='bg-orange-500 text-white p-2 rounded-lg mt-2'>Edit</button>
                            </div>
                            <button onClick={handleAddAddress} className='bg-orange-500 text-white p-2 rounded-lg'>Add New Address</button>
                            {addAddress && (
                                <form className='border-2 rounded-lg p-4 mt-4' action="submit">
                                    <label className='flex flex-col gap-2' htmlFor="address">
                                        Address:
                                        <input required className='border-2 outline-none p-1 rounded-lg' type="text" placeholder='Address' />
                                    </label>
                                    <label className='flex flex-col gap-2' htmlFor="city">
                                        City:
                                        <input required className='border-2 outline-none p-1 rounded-lg' type="text" placeholder='City' />
                                    </label>
                                    <label className='flex flex-col gap-2' htmlFor="state">
                                        State:
                                        <input required className='border-2 outline-none p-1 rounded-lg' type="text" placeholder='State' />
                                    </label>
                                    <label className='flex flex-col gap-2' htmlFor="zip">
                                        Zip Code:
                                        <input required className='border-2 outline-none p-1 rounded-lg' type="text" placeholder='Zip Code' />
                                    </label>
                                    <button type="submit" className='bg-orange-500 text-white p-2 rounded-lg mt-2'>Save Address</button>
                                </form>
                            )}
                        </div>
                    </div>
